...
<html lang="en">
<head>
    <title>Perpustakaan <?php echo get_sistem("nama"); ?> | Paramount <?php echo getVersion(); ?></title>
...
<body>
    <div class="container">
        <div class="well" style="margin-top: 20px;">
            ...
            <p class="alert alert-warning">Catatan: Format import harus sesuai standart aplikasi Paramount<br><br><a href="import_anggota.xls" class="btn btn-success">Download Format Import</a></p>
            ...
            <p class="alert alert-warning">Catatan: Format import harus sesuai standart aplikasi Paramount.<br><br><a href="import_buku.xls" class="btn btn-success">Download Format Import</a></p>
            <?php endif; ?>
            <?php if(!empty($mode)): ?>
