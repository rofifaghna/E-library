...
<html lang="en">
<head>
    <title>Perpustakaan <?php echo get_sistem("nama"); ?> | ZARAAULIA<?php echo getVersion(); ?></title>
...
<body>
    <div class="container" style="margin-top: 20px;">
        <div class="well">
            ...
            <p>Langkah ini digunakan untuk mengupgrade Database dari ZARAAULIA Versi 3.0.0 ke versi 3.1.0</p>
