...
if($_GET['naik']=='kelas'){
    $lulusan=date('Y');
    $first=mysql_query("UPDATE tbl_anggota SET kelas=\"Alumni$lulusan\" WHERE kelas=\"X\"");
  
        $second=mysql_query("UPDATE tbl_anggota SET kelas=\"X\" WHERE kelas=\"VIII\"");
       
            $third=mysql_query("UPDATE tbl_anggota SET kelas=\"VIII\" where kelas=\"VII\"");
            
                $third1=mysql_query("UPDATE tbl_anggota SET kelas=\"VII\" where kelas=\"VI\"");
               
                    $third2=mysql_query("UPDATE tbl_anggota SET kelas=\"VI\" where kelas=\"V\"");
                   
                     $third3=mysql_query("UPDATE tbl_anggota SET kelas=\"V\" where kelas=\"IV\"");
                       
                            $third4=mysql_query("UPDATE tbl_anggota SET kelas=\"IV\" where kelas=\"III\"");
                         
                               
                                         $third6=mysql_query("UPDATE tbl_anggota SET kelas=\"II\" where kelas=\"I\"");
